...
import { Box, Button, TextField, Typography, Stack, Checkbox, Grid, CircularProgress, Backdrop, Paper } from "@mui/material";
  ...
  return (
    <div>
      ...
      <Box display='flex'>
        <Box width='20%' p={2}>
          ...
          <Box sx={{ width: "100%", display: "flex", justifyContent: "center" }}>
            <Button component='label' variant='contained' sx={{ backgroundColor: "#3D5CAC", width: "193px", height: "35px" }}>
              Add Profile Pic
        ...
        <Box width='80%' p={3} sx={{ overflowY: "auto" }}>
          <Stack spacing={2} direction='row'>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "100%" }}>{"First Name"}</Typography>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "100%" }}>{"Last Name"}</Typography>
          </Stack>
          <Stack spacing={2} direction='row'>
          ...
          <Stack spacing={2} direction='row'>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "50%" }}>{"Personal Address"}</Typography>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "10%" }}>{"Unit"}</Typography>

            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "20%" }}>{"City"}</Typography>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "10%" }}>{"State"}</Typography>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "10%" }}>{"Zip"}</Typography>
          </Stack>
          ...
          <Stack spacing={2} direction='row'>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "100%" }}>{"Personal Email"}</Typography>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "100%" }}>{"Personal Phone"}</Typography>
          </Stack>
          <Stack spacing={2} direction='row'>
          ...
          <Stack spacing={2} direction='row'>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight, width: "100%" }}>{"SSN"}</Typography>
          </Stack>
          <Stack spacing={2} direction='row'>
      ...
      <Box display='flex' justifyContent='center' alignItems='center' flexDirection='column' p={5}>
        <Button variant='contained' onClick={handleNextStep} disabled={nextStepDisabled} sx={{ mb: 2, backgroundColor: "#3D5CAC" }}>
          Save
        </Button>
      </Box>
    </div>
