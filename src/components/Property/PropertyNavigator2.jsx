    ...
    >
        ...
        <Box sx={{ marginTop: '26px', padding: isMobile? '0px' : '20px' }}>
            <Box sx={{ height: '30px', }}>
                ...
                />
                <Tab 
                    label= {isMobile? "PM" : "Management"}
                    {...a11yProps(2)} 
                    sx={tabSX}
                />
                <Tab 
                    label={isMobile ? "Rent" : "Rent History"}
                    {...a11yProps(2)} 
                    sx={tabSX}
                />
                <Tab 
...
function CustomTabPanel(props) {
    ...
    return (
      ...
      >
        ...
        {value === index && <Grid sx={{ paddingBottom: '10px', backgroundColor:"#FFFFFF", borderBottomLeftRadius: '8px', borderBottomRightRadius: '8px',}} container>{children}</Grid>}
      </div>
    );
}    
                        ...
                        {property && property?.property_available_to_rent === 1 && (property.lease_status == null || property.lease_status !== "ACTIVE") && (
                          ...
                          <Box >
                            ...
                            >
                                {
                                    !isMobile && (
                                        <CheckIcon sx={{ color: "#FFFFFF", fontSize: isMobile? '10px' : "18px" }} />
                                    )
                                }
                              <Typography
                                sx={{
