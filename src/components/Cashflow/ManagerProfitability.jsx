...
const ManagerProfitability = ({ propsMonth, propsYear, profitsTotal, profits, rentsTotal, rentsByProperty, payoutsTotal, payouts, setMonth, setYear, profitsCurrentYear, profitsTotalCurrentYear, rentsTotalCurrentYear, rentsByPropertyCurrentYear, payoutsCurrentYear, payoutsTotalCurrentYear}) => {
          ...
          >
            ...
            {tab === "by_month" && <>
              ...
              >
                ...
                <AccordionDetails>
                  {profitsCurrentYear && Object.keys(profitsCurrentYear).map((month, monthIndex) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <AccordionDetails>
                          {monthData?.properties && Object.keys(monthData.properties).map((propertyUID, propertyIndex) => {
              ...
              >
                ...
                {/* All Monthly Accordions inside the Profit Accordion */}
                <AccordionDetails>
                  {rentsByPropertyCurrentYear && Object.keys(rentsByPropertyCurrentYear).map((month, monthIndex) => {
              ...
              >
                ...
                {/* All Monthly Accordions inside the Profit Accordion */}
                <AccordionDetails>
                  {payoutsCurrentYear && Object.keys(payoutsCurrentYear).map((month, monthIndex) => {
