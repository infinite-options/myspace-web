...
const SelectPayment = ({ selectedPayment, selectedPurGroup, }) => {
    ...
    console.log("ROHIT - selectedPayment - ", selectedPayment);
    console.log("ROHIT - selectedPurGroup - ", selectedPurGroup);
