  ...
  const handleClose = () => {
    ...
    const columns = isEditable ? [
      ...
      },
      {
        ...
        renderCell: (params) => (
          <Box>
            <IconButton onClick={() => {handleClickEditFee(params.row)}}>
      ...
      },
      {
        ...
        renderCell: (params) => (
          <Box>
            <IconButton onClick={() => {handleDeleteClickFee(params.row.id)}}>
            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                ...
                <Grid item xs={6}>
                  <Stack spacing={-2} m={2}>
                    ...
                    <TextField name='charge' value={currentRow.charge} variant='filled' fullWidth className={classes.root} onChange={(e) => {
                      setCurrentRow((prev)=>{
                        return(
                          {
                            ...prev,
                ...
                <Grid item xs={6}>
                  <Stack spacing={-2} m={2}>
                    ...
                    {(currentRow.frequency === "Monthly" || currentRow.frequency === "Semi-Monthly" || currentRow.frequency === "Semi-Annually" || currentRow.frequency === "Quarterly") && (
                      <TextField
                        name='due_by'
                ...
                <Grid item xs={6}>
                  <Stack spacing={-2} m={2}>
                    ...
                    {(currentRow.frequency === "Monthly" || currentRow.frequency === "Semi-Monthly" || currentRow.frequency === "One Time" || currentRow.frequency === "Annually" || currentRow.frequency === "Semi-Annually" || currentRow.frequency === "Quarterly") && (
                      <TextField
                ...
                <Grid item xs={6}>
                  <Stack spacing={-2} m={2}>
                    ...
                    <TextField name='late_fee' value={currentRow.late_fee} variant='filled' fullWidth className={classes.root} onChange={(e) =>{
                      setCurrentRow((prev)=>{
                        return(
                          {
                            ...prev,
