...
import { Typography, Box, Paper, Grid, Button, Card, CardContent, CardMedia, Dialog, DialogContent, DialogContentText, DialogActions, DialogTitle, TextField } from "@mui/material";
    ...
    <Paper sx={{ margin: "10px", backgroundColor: color, paddingBottom: "10px" }}>
      {isEditable && (
        <Box sx={{ display: "flex", flexDirection: "row-reverse", height: "20px" }}>
          ...
          <Dialog open={open} close={handleCloseDialog} aria-labelledby='alert-dialog-title' aria-describedby='alert-dialog-description' maxWidth='md'>
            ...
            <DialogContent>
              <DialogContentText id='alert-dialog-description'>
                <Grid container spacing={6}>
                  <Grid item md={6}>
                    <Typography sx={{ fontSize: "14px", fontWeight: "bold", color: "#3D5CAC", marginTop: "10px", textAlign: "center" }}>Start Date</Typography>
                  ...
                  <Grid item md={6}>
                    <Typography sx={{ fontSize: "14px", fontWeight: "bold", color: "#3D5CAC", marginTop: "10px", textAlign: "center" }}>End Date</Typography>
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                      <DatePicker
                        label='End Date'
      ...
      <Grid container spacing={2} sx={{ marginBottom: "15px" }}>
        ...
        {isMobile && (
          <Grid display={"flex"} direction={"row"} marginLeft={"10px"}>
            ...
            <Grid item xs={6} md={3}>
              <Grid container marginTop='10px'>
                ...
                <Grid item xs={6} md={6} sx={{ marginBottom: "10px" }}>
                  ...
                  >
                    {formatDate(currentLease.lease_end)}
                  </Typography>
                </Grid>
                <Grid item xs={6} md={6} sx={{ marginBottom: "10px" }}>
                  <Typography
                ...
                <Grid item xs={6} md={6} sx={{ marginBottom: "10px" }}>
                  ...
                  >
                    {currentLease.lease_move_in_date}
                  </Typography>
                </Grid>
                <Grid item xs={6} md={6} sx={{ marginBottom: "10px" }}>
                  <Typography
                ...
                <Grid item xs={6} md={6} sx={{ marginBottom: "10px" }}>
                  ...
                  >
                    {currentLease?.lease_m2m && currentLease?.lease_m2m === 1 ? "Yes" : "No"}
                  </Typography>
                </Grid>
            ...
            <Grid item xs={6} md={4}>
              <Grid container marginTop='10px'>
                ...
                <Grid item xs={6} md={6} sx={{ marginBottom: "10px" }}>
                  ...
                  >
                    {isMobile ? "Avl To Pay" : "Available to Pay"}
                  </Typography>
                </Grid>
                <Grid item xs={6} md={6} sx={{ marginBottom: "10px" }}>
                  <Typography
                  ...
                  >
                    {rent?.available_topay} Days Before
                  </Typography>
                </Grid>
                ...
                <Grid item xs={6} md={6} sx={{ marginBottom: "10px" }}>
                  ...
                  >
                    {rent?.due_by} {getDateAdornmentString(rent?.due_by)}
                  </Typography>
                </Grid>
              </Grid>
            </Grid>
