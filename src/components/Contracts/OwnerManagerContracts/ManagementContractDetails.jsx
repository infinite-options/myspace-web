...
function ManagementContractDetails(props) {
  ...
  useEffect(() => {
    ...
    const { currentContractUID: contractUIDFromManagement, currentContractPropertyUID: contractPropertyUIDFromManagement, contractRequests } = managementContractContext || {};

    const { newContractUID: contractUIDFromProperties, newContractPropertyUID: contractPropertyUIDFromProperties } = propertiesContext || {};
