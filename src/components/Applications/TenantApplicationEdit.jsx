    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            >
                ...
                <Grid container>
                    <Grid container item xs={12} md={12} sx={{ alignItems: "center", justifyContent: "space-between" }}>
                        <Grid item xs={1} sx={{
                            display: "flex",
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    minWidth: "unset", // Removes extra padding around the button
                                    padding: 0,
                                }}
                            >
                                {/* <CloseIcon sx={{ color: "black", fontSize: isMobile ? "25px" : "30px" }} /> */}
                                <ArrowBackIcon
                                    sx={{
                                        color: "#160449",
                                        fontSize: "25px",
                    ...
                    <Grid container xs={12} flexDirection={"row"}>
                        <Grid container justifyContent='center' item xs={12}>
                            ...
                            >
                                <Typography sx={{ textTransform: "none", fontWeight: theme.typography.primary.fontWeight, color: "#FFFFFF", fontSize: isMobile ? "14px" : "16px", }}>
                                    {props.lease == null ||
                                        ...
                                        : ""}
                                    {props.lease?.lease_status == "NEW" || props.lease?.lease_status == "PROCESSING" ? isMobile ? "Update" : "Update Lease Application" : ""}
                                    {(props.lease?.lease_status == "ACTIVE" ||
                                        ...
                                        ? isMobile ? "Submit Renewal" : "Submit Lease Renewal"
                                        : ""}
                                    {props.lease?.lease_status == "RENEW REQUESTED" ||
                                        ...
                                        ? isMobile ? "Update Renewal" : "Update Lease Renewal"
                                        : ""}
                                </Typography>
                            </Button>
