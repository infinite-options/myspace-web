...
const TenantAccountBalance = ({
  ...
  console.log("In Tenant Account Balance");
  console.log("Prashant: ", balanceDetails);
        ...
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", marginTop: "20px" }}>
            <CardMedia
              component='img'
              image={
                selectedProperty?.property_favorite_image
                  ? selectedProperty?.property_favorite_image
                  : selectedProperty?.property_images
                  ? JSON.parse(selectedProperty.property_images)[0]
                  : defaultHouseImage
              }
              alt='property image'
              ...
              <Table sx={{ "& .MuiTableCell-root": { padding: "8px", fontSize: "14px" } }}>
                <TableHead>
                  <TableRow sx={{ backgroundColor: "#f0f0f0" }}>
                    ...
                    <TableCell sx={{ padding: "8px", fontWeight: "bold", color: "#160449" }}>Due Date</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {balanceDetails.map((detail, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell sx={{ padding: "8px" }}>{dayjs(detail.dueDate, 'MM-DD-YYYY').format("MM/DD/YYYY")}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
