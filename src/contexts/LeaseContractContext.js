...
export const LeaseContractProvider = ({ children }) => {
  ...
  useEffect(() => {
    // console.log("LeaseContractContext - currentContractUID - ", currentContractUID);
  }, [currentContractUID]);

  useEffect(() => {
    // console.log("LeaseContractContext - currentContractPropertyUID - ", currentContractPropertyUID);
